...
class Charizard : public Fire, public SkillCharizard {
    public:
        Charizard(string name, string* parentname, string* parentspecies, int numskill, int X, int Y);
...
class Glaceon : public Ice, public SkillGlaceon {
    public:
        Glaceon(string name, string* parentname, string* parentspecies, int numskill, int X, int Y);
...
class Onix : public Ground, public SkillOnix {
    public:
        Onix(string name, string* parentname, string* parentspecies, int numskill, int X, int Y);
        Onix(const Onix&);
...
class Pikachu : public Electric, public SkillPikachu {
    public:
        Pikachu(string name, string* parentname, string* parentspecies, int numskill, int X, int Y);
...
class Squirtle : public Water, public SkillSquirtle {
    public:
        Squirtle(string name, string* parentname, string* parentspecies, int numskill, int X, int Y);
...
class Rotom : public FireElectric, public SkillRotom {
    public:
        Rotom(string name, string* parentname, string* parentspecies, int numskill, int X, int Y);
        Rotom(const Rotom&);
...
class Wooper : public WaterGround, public SkillWooper {
    public:
        Wooper(string name, string* parentname, string* parentspecies, int numskill, int X, int Y);
        Wooper(const Wooper&);
...
class Cloyster : public WaterIce, public SkillCloyster {
    public:
        Cloyster(string name, string* parentname, string* parentspecies, int numskill, int X, int Y);
